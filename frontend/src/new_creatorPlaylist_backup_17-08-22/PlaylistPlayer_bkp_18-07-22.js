...
export const PlaylistPlayer = ({ playlists }) => {
  ...
  const nextyoutuberesults = (e) => 
  {
    ...
    if(tempSearchKeyword!='') // ps
      ...
      setSearchKeyword(searchKeyword+1);

    alert(searchKeyword); // ps
    searchYoutubeVideo(e);
  };

  const previousyoutuberesults = (e) => {
    if(searchKeyword == NaN){
    setSearchKeyword(searchKeyword - 1);
    }
  ...
  return (
    <>
        ...
        <div className="col-12 col-md-3  ">
          <div className="borderRadius todayList">
            <div className="row">
              <div className="col-6">
                <div
                  className="borderRadius todayList"
            ...
            <div className="row">
              ...
              <div className="col-4">
                <div className="borderRadius todayList buttonPadding">
                  {isLogin !== null ? (
                    <button
          ...
          <div className="borderRadius todayList">
            ...
            <div className="row my-3">
              <div className="col-4 my-2">
                <div className="todayList borderRadius buttonPadding">
                  <button
      ...
      <div className="row todayList" style={{ borderTop: "none" , borderLeft:"none"}}>
        <div className="col-12 col-md-3">
