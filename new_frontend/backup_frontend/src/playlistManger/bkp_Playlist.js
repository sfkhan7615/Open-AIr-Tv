...
function Playlist() {
  ...
  const [YoutubeTempPlaylist, setYoutubeTempPlaylist] = useState(currentPlaylistVideoData);
                        ...
                        return (
                          <div key={index} className='playlist_main_box mb-2' style={{ position: 'relative', background: 'rgba(0,0,0,0.5)' }}>
                            ...
                            <ul className='icons' style={{ height: '100%', position: 'absolute', top: '25%', left: '-28px', listStyle: 'none' }}>
                              <li><img src={require('../asset/images/Button_moveUp2.png')} className="img-fluid" alt="" style={{ width: '22px' }} /></li>
