                        ...
                        >
                          <div className="info">
                            ...
                            >
                              ...
                              <l title={val.title} style={{fontSize:"12px"}}>{val.title.length <= 30 ? val.title.substring(0,30) : <marquee>{val.title}</marquee>}</l>
                              <br />
                              <l title={val.description}>{val.description.substring(0,50)}...</l>
                              <br/>
                              {val.channel_name}  {val.publishTime}
                              <br />
                              {moment(val.publishTime).utc().format('MM/DD/YYYY')}
                              <br/>
                      ...
                      <div className="creator_VideoBadge">
                        ...
                        >
                          <div className="info">
                            ...
                            >
                            <l style={{fontSize:"12px"}} title={video.snippet.title}>{video.snippet.title.length <= 30 ? video.snippet.title.substring(0,30) : <marquee>{video.snippet.title}</marquee>}</l>
