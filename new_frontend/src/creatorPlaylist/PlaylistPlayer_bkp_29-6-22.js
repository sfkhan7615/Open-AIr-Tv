...
export const PlaylistPlayer = ({ playlists }) => {
  ...
  const searchYoutubeVideo = (e) => {
    ...
    if (searchKeyword.length > 1) {
      ...
      axios
            .get(`https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=50&q=` +searchKeyword +`&key=` +YoutubeApiKey)
            .then((videos) => 
            {
               var tempData = [];
...
// console.log(allYoutubeSearchVideoData[1].id.videoId);
  return (
    <>
      <div className="row" onClick={closeMenu}>
        <div
        ...
        <div className="col-12 col-md-3 p-0">
          <div style={{ background: "rgba(255,255,255,0.2)" }}>
            <div className="row">
              <div className="col-6">
                {isLogin != null ? (
                  ...
                  >
                    <img
                      src={require("../asset/images/Button_PasteCode.png")}
                      className="img-fluid"
                      alt=""
            ...
            <div className="row ms-2 text-white">
              Currently Playing : {currentPlaylist.title}
            </div>
                        ...
                        >
                          <div className="info">
                            ...
                            >
                              ...
                              <br/>
                              {val.channel_name}  {val.publishTime}
                              <br />
            ...
            <ul
              className={
                socialMediaMenu ? "dropDownSetting" : "dropDownSetting hidden"
              }
              style={{
                padding: "0 18px",
                position: "absolute",
                      ...
                      <div className="creator_VideoBadge">
                        ...
                        >
                          <div className="info">
                            ...
                            >
                            <l>{video.snippet.title.substring(0,10)}
                            <br />
                            {video.snippet.description.substring(0,25)}...</l>
                            <br/>
                          ...
                          >
                            <div className="info">
                              ...
                              >
                                {video.name}
                                <br />
                                {video.user.name} - {video.created_time}
                                <br />
                                {video.description
                                ...
                                video.categories.length != 0 ? (
                                    ...
                                    categories : {video.categories[0].name}
                                    <br />
